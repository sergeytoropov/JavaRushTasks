    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                String a = IntStream.range(0, i).mapToObj(i -> new String("а")).reduce("", (acc, element) -> acc + element);
                return getSuperQuotes() + getName() + getSuperQuotes() + " лает г" + a + "в! " + formatter.format(new Date());
            }
        }
        return new DogPet();
    }
